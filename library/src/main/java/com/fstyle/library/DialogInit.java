...
import com.fstyle.library.internal.MDAdapter;
...
class DialogInit {
    ...
    public static void init(final MaterialDialog dialog) {
        ...
        if (!builder.neutralColorSet) {
            builder.neutralColor = DialogUtils.resolveActionTextColorStateList(builder.context,
        ...
        if (!builder.titleColorSet) {
            ...
            builder.titleColor = DialogUtils.resolveColor(builder.context, R.attr.md_title_color,
                    titleColorFallback);
        }
        if (!builder.contentColorSet) {
            ...
            builder.contentColor =
                    DialogUtils.resolveColor(builder.context, R.attr.md_content_color,
                            contentColorFallback);
        }
        if (!builder.itemColorSet) {
            builder.itemColor = DialogUtils.resolveColor(builder.context, R.attr.md_item_color,
                    builder.contentColor);
        }
        ...
        dialog.positiveButton.setVisibility(
                builder.positiveText != null ? View.VISIBLE : View.GONE);
        dialog.neutralButton.setVisibility(builder.neutralText != null ? View.VISIBLE : View.GONE);
        dialog.negativeButton.setVisibility(
                builder.negativeText != null ? View.VISIBLE : View.GONE);
        ...
        if (builder.limitIconToDefaultSize || DialogUtils.resolveBoolean(builder.context,
            ...
            maxIconSize =
                    builder.context.getResources().getDimensionPixelSize(R.dimen.md_icon_max_size);
        }
        if (maxIconSize > -1) {
        ...
        if (!builder.dividerColorSet) {
            final int dividerFallback =
                    DialogUtils.resolveColor(dialog.getContext(), R.attr.md_divider);
            builder.dividerColor =
                    DialogUtils.resolveColor(builder.context, R.attr.md_divider_color,
                            dividerFallback);
        }
        ...
        if (dialog.content != null) {
            ...
            if (builder.linkColor == null) {
                dialog.content.setLinkTextColor(DialogUtils.resolveColor(dialog.getContext(),
        ...
        dialog.positiveButton.setStackedSelector(
                dialog.getButtonSelector(DialogAction.POSITIVE, true));
        ...
        dialog.negativeButton.setStackedSelector(
                dialog.getButtonSelector(DialogAction.NEGATIVE, true));
        ...
        dialog.neutralButton.setStackedSelector(
                dialog.getButtonSelector(DialogAction.NEUTRAL, true));
        dialog.neutralButton.setDefaultSelector(
                dialog.getButtonSelector(DialogAction.NEUTRAL, false));
            ...
            if (builder.adapter == null) {
                ...
                if (builder.listCallbackSingleChoice != null) {
                    ...
                    if (builder.selectedIndices != null) {
                        dialog.selectedIndicesList =
                                new ArrayList<>(Arrays.asList(builder.selectedIndices));
            ...
            if (!builder.indeterminateProgress || builder.indeterminateIsHorizontalProgress) {
                ...
                if (dialog.progressMinMax != null) {
                    ...
                    if (builder.showMinMax) {
                        ...
                        dialog.progressMinMax.setText(String.format(builder.progressNumberFormat, 0,
                                builder.progressMax));
    ...
    private static void setupInputDialog(final MaterialDialog dialog) {
        ...
        if (builder.inputType != -1) {
            ...
            if (builder.inputType != InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD
                ...
                // If the flags contain TYPE_TEXT_VARIATION_PASSWORD, apply the password
                // transformation method automatically
